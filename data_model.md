...
| GBFSStationStatus | station_status | dataModel.GBFS | Real-time station availability per station |
...
Official description: real-time capacity and rental availability for each station entity.
