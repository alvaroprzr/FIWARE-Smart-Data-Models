        ...
        stations.append(
            {
                ...
                "rental_uris": {
                    "android": f"https://bicicoruna.example.com/rent/android/{station['station_id'].lower()}",
                    "ios": f"https://bicicoruna.example.com/rent/ios/{station['station_id'].lower()}",
                    "web": f"https://bicicoruna.example.com/rent/{station['station_id'].lower()}",
                },
            }
        )
...
def build_device_entities() -> List[Dict[str, Any]]:
    ...
    for index, station in enumerate(STATIONS, start=1):
        serial_number = f"SENSOR-ACORUNA-{index:03d}"
